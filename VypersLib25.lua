...
function Section:_buildDropdown(opts, multi)
	...
	local open = false
	local posConn
	-- OVERLAY MODE (non-sidebar): the option list floats ON TOP of the elements
	-- below it (classic dropdown). The row keeps its fixed height -- only the list
	-- drops down over the other rows, nothing gets pushed around.
